...
const checkUserExistence = (email, nickname, collection) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isEmailExist === 1 && isNicknameExist === 1) {
            const errorObject = (0, ResponseGenerator_1.ResponseGenerator)("ERROR")(500, "UserExistenceValidation Decorator: Decorator function error:CheckUserExistence Function", "User with this nickname and email already exist.");
            return errorObject;
        }
            ...
            const errorObject = (0, ResponseGenerator_1.ResponseGenerator)("ERROR")(500, "UserExistenceValidation Decorator: Decorator function error:CheckUserExistence Function", "User with this email adress already exist.");
            return errorObject;
        }
        else if (isNicknameExist === 1) {
            const errorObject = (0, ResponseGenerator_1.ResponseGenerator)("ERROR")(500, "UserExistenceValidation Decorator: Decorator function error:CheckUserExistence Function", "User with this nickname already exist.");
            return errorObject;
        }
    }
    catch (error) {
